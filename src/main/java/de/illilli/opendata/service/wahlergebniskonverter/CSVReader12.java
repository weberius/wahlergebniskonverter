...
/**
 * Die Klasse CSVReader12 berücksichtigt 12 Spalten bevor die eigentliche
 * Wahlergebnisse ausgelesen werden.
 *
 */
public class CSVReader12 {

	private List<Stimmbezirk> data = new ArrayList<>();

	public CSVReader12(Reader reader) throws IOException {
